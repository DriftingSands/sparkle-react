export default function LayerImage({ data, panelNr, host, viewType }) {
  ...
  const source = `${host}/${image?._path.startsWith('/') ? image._path.substring(1) : image._path}/_jcr_content/renditions/${typeLookup[viewType] || 'desktop.webp'}`;
